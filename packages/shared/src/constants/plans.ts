...
/** Allineato a `docs/architettura/ARCHITETTURA_LIVE_SLIDE_CENTER.md` § 21 (Piani commerciali) + `docs/commerciali/Listino_Prezzi.md` — non modificare senza aggiornare entrambi. */
