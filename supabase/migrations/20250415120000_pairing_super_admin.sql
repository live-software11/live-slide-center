-- Pairing (paired_devices, pairing_codes) + super_admin + Realtime come da docs/GUIDA_DEFINITIVA_PROGETTO.md §7
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.paired_devices TO anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.pairing_codes TO anon, authenticated;
