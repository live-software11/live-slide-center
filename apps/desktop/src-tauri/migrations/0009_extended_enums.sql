...
CREATE TABLE IF NOT EXISTS presentation_versions_new (
  ...
  uploaded_by_user_id TEXT REFERENCES users(id) ON DELETE
  SET NULL,
    upload_source TEXT NOT NULL DEFAULT 'web_portal' CHECK (
      upload_source IN (
        'web_portal',
        'preview_room',
        'agent_upload',
...
ALTER TABLE presentation_versions_new
  RENAME TO presentation_versions;
