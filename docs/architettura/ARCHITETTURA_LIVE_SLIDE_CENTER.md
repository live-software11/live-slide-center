...
| 024 | Smoke test cloud SOLO via env vars / CLI flags (Sprint X-1)          | Mai hardcodare credenziali in repo, anche se scoped a field test. Password live solo su Raven/Andrea; stub in `docs/archivio/FIELD_TEST_CREDENTIALS.md` |
