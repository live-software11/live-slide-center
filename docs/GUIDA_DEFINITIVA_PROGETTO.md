...
| 13    | Integrazioni ecosistema                    | **Completata (100%)** | `/settings`: sezione ecosistema (`settings.integrations*`) — link esterni Timer/CREW se `VITE_LIVE_SPEAKER_TIMER_URL` / `VITE_LIVE_CREW_URL` (`.env.example`); API pubblica come testo + badge *in arrivo* senza endpoint; sync cross-app e REST documentata = post-MVP.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
